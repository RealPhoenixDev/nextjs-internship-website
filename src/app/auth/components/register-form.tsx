...
export default function RegisterForm() {
    ...
    return (
        ...
        <Form validationBehavior='native' className="mt-8 gap-4" onSubmit={onSubmit}>
            ...
            />
            <Button type='submit' radius='sm' className="w-full bg-primary-500 h-14">Register</Button>
        </Form>
    )
}